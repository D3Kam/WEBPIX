    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mb-12 grid grid-cols-1 items-start justify-between gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
          <div>
            <p className="mb-3 font-semibold md:mb-4">Tray</p>
          ...
          <div>
            <p className="mb-5 text-medium md:mb-4">
              Track your chosen blocks with real-time updates. Edit and manage
              ...
              <ul className="grid grid-cols-1 gap-4 py-2">
                ...
                <li className="flex self-start">
                  <div className="mr-4 flex-none self-start">
                    <img
                      className="size-6 text-scheme-text"
                      src="https://cdn.jsdelivr.net/npm/@material-symbols/svg-500@latest/rounded/ring_volume.svg"
                    />
                  </div>
