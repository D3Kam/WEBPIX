...
export default function Purchase() {
  ...
  return (
    <div className="min-h-screen bg-neutral-lightest">
      ...
      {/* Progress Steps */}
      <section className="border-b border-neutral-light bg-white px-[5%] py-6">
        <div className="container max-w-4xl">
          <div className="flex items-center justify-center gap-4">
            <div className={`flex items-center gap-2 ${step >= 1 ? 'text-brand-primary' : 'text-neutral'}`}>
              <div className={`flex h-8 w-8 items-center justify-center rounded-full ${step >= 1 ? 'bg-brand-primary text-white' : 'bg-neutral-lighter'}`}>
                1
              </div>
              <span className="hidden font-medium sm:inline">Select Sector</span>
            </div>
            <div className="h-px w-12 bg-neutral-lighter" />
            <div className={`flex items-center gap-2 ${step >= 2 ? 'text-brand-primary' : 'text-neutral'}`}>
              <div className={`flex h-8 w-8 items-center justify-center rounded-full ${step >= 2 ? 'bg-brand-primary text-white' : 'bg-neutral-lighter'}`}>
                2
              </div>
              <span className="hidden font-medium sm:inline">Connect Wallet</span>
            </div>
            <div className="h-px w-12 bg-neutral-lighter" />
            <div className={`flex items-center gap-2 ${step >= 3 ? 'text-brand-primary' : 'text-neutral'}`}>
              <div className={`flex h-8 w-8 items-center justify-center rounded-full ${step >= 3 ? 'bg-brand-primary text-white' : 'bg-neutral-lighter'}`}>
                3
              </div>
      ...
      {/* Trust Indicators */}
      <section className="border-t border-neutral-light bg-white px-[5%] py-12">
        <div className="container max-w-4xl">
          <div className="grid gap-8 md:grid-cols-3">
            <div className="text-center">
              <Shield className="mx-auto mb-3 h-8 w-8 text-brand-primary" />
              <h3 className="mb-2 font-bold">Secure Blockchain</h3>
              <p className="text-sm text-neutral-dark">Your ownership is permanently recorded on Ethereum</p>
            </div>
            <div className="text-center">
              <Zap className="mx-auto mb-3 h-8 w-8 text-brand-primary" />
              <h3 className="mb-2 font-bold">Instant Confirmation</h3>
              <p className="text-sm text-neutral-dark">See your pixels appear on the canvas immediately</p>
            </div>
            <div className="text-center">
              <Wallet className="mx-auto mb-3 h-8 w-8 text-brand-primary" />
              <h3 className="mb-2 font-bold">Your Wallet, Your Art</h3>
